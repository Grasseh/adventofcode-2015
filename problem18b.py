...
lights[0][0].on = True
lights[0][size-1].on = True
lights[size-1][0].on = True
lights[size-1][size-1].on = True
...
for i in range(0,steps):
  ...
  lights[0][size-1].next = True
  lights[size-1][0].next = True
  lights[size-1][size-1].next = True
